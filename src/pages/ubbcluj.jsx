...
// Real theme assets, hotlinked from cs.ubbcluj.ro (CSUBB WordPress theme)
const THEME = "https://www.cs.ubbcluj.ro/wp-content/themes/CSUBB";
const SITE = "https://www.cs.ubbcluj.ro";

// Real menu structure of cs.ubbcluj.ro (Romanian main menu)
const MENU = [
  {
    label: "Studenţi",
    href: `${SITE}/studenti/`,
...
// Real (current) announcements from the cs.ubbcluj.ro homepage
const POSTS = [
  {
    title:
...
// Widget title bar, replicating .widgettitle from the CSUBB theme
...
export default function UbbCluj({ onBack }) {
  ...
  return (
    ...
    >
      ...
      {/* #container — 960px centered, like the real site */}
      <div className="w-[960px] max-w-full mx-auto px-2 lg:px-0">
        {/* #header — logo left, search + social profiles right */}
        ...
        {/* .menu-primary-container — 46px dark bar with dropdowns */}
        <nav
            ...
            <li className="ml-auto flex items-center gap-[7px] pr-[10px]">
              ...
              <a href={SITE} target="_blank" rel="noopener noreferrer" title="Magyar">
                <span
                  ...
                  style={{
                    background:
                      "linear-gradient(to bottom, #CE2939 33%, #fff 33%, #fff 66%, #477050 66%)",
                  }}
                />
              </a>
              <a href={SITE} target="_blank" rel="noopener noreferrer" title="Deutsch">
                <span
                  ...
                  style={{
                    background:
                      "linear-gradient(to bottom, #000 33%, #DD0000 33%, #DD0000 66%, #FFCE00 66%)",
                  }}
                />
              </a>
            </li>
        ...
        {/* #main — white, two columns: #content 645px + #sidebar-primary 300px */}
        <div className="bg-white pb-[15px] pt-[15px] flex flex-col lg:flex-row gap-[15px]">
          ...
          <div className="w-full lg:w-[645px] shrink-0 px-2 lg:px-0">
            {/* .csubbTitle + #player — video banner */}
            <div className="ml-[13px] text-[#414445] text-[16px] leading-[20px] font-bold uppercase mb-2">
              Viaţa bate filmul! Descoperă Facultatea de Matematică şi
              Informatică în 8 minute!
            </div>
            <div className="mb-6">
              <iframe
            ...
            {/* Announcement posts — .post-box */}
            {POSTS.map((p) => (
              <div
                key={p.title}
                className="border-b border-dashed border-[#bbbbbb] pb-4 mb-5 overflow-hidden"
              >
                <h2 className="text-[17px] leading-[22px] font-bold mb-[10px]">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#1B1E1F] hover:text-[#608ca4]"
                  >
                    {p.title}
                  </a>
                </h2>
                ...
                <p className="text-[13px] leading-[19px] text-[#1B1E1F] mb-2">
                  {p.excerpt}
                </p>
                {/* .readmore */}
                <a
          ...
          <div className="w-full lg:w-[300px] shrink-0 px-2 lg:px-0">
            ...
            <div className="mb-6">
              ...
              <div className="text-[13px] leading-[18px]">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#47504F] hover:text-[#608ca4]"
                >
                  Concurs de matematică și informatică pentru elevi — admitere
                  fără examen pentru premianți. Detalii și regulament.
                </a>
              </div>
            </div>
            ...
            <div className="mb-6">
              <WidgetTitle>
                Informații utile și de actualitate pentru studenți
              </WidgetTitle>
              <ul>
                {SIDEBAR_LINKS.map((l) => (
                  <li
                    key={l}
                    className="border-b border-dashed border-[#bbbbbb] pb-[9px] mb-[8px] pl-[12px] relative"
                  >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[#47504F] leading-[18px] hover:text-[#608ca4]"
                    >
                      {l}
                    </a>
                  </li>
            ...
            <div className="mb-6">
              <WidgetTitle>
                Următoarele evenimente găzduite de facultate
              </WidgetTitle>
              <ul>
        ...
        {/* #footer-widgets — dark slate strip */}
        <div className="bg-[#4D5B59] text-white px-[15px] pt-[20px] pb-[15px] mb-[10px] flex flex-col md:flex-row gap-6">
          <div className="md:w-1/3">
            <div className="text-[14px] font-bold uppercase border-b border-[#2A3533] pb-[4px] mb-[10px]">
              Contact
            </div>
            <p className="text-[12px] leading-[18px]">
              ...
              <br />
              E-mail:{" "}
              <a href="mailto:math@ubbcluj.ro" className="text-white underline hover:text-[#9fc0d3]">
                math@ubbcluj.ro
              </a>
            </p>
          </div>
          <div className="md:w-1/3">
            ...
            <ul className="text-[12px] leading-[18px] space-y-1">
              <li>
                <a
                  href="https://academicinfo.ubbcluj.ro"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white hover:text-[#9fc0d3] hover:underline"
                >
                  AcademicInfo
                </a>
              </li>
              ...
              {SOCIAL_ICONS.map((name) => (
                ...
                >
                  <img
                    src={`${THEME}/images/social-profiles/${name}.png`}
                    alt={name}
                    className="h-[24px] w-auto mr-[6px] mb-[6px]"
                  />
                </a>
              ))}
            </div>
        ...
        <div className="text-[12px] leading-[18px] text-[#47504F] pb-[60px] px-2 lg:px-0">
          &copy; 1996-2026 | Facultatea de Matematică și Informatică,
          Universitatea Babeș-Bolyai Cluj-Napoca |{" "}
          <a
            href="https://www.ubbcluj.ro/ro/protectia_datelor/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#608ca4] hover:underline"
          >
